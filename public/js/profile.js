...
$(document).ready(function() {
    ...
    ConvertForfeitRate('#unseeded-solo-numfor-val');
    ConvertRaceTime('#unseeded-solo-adjavg-val');
    ConvertRaceTime('#unseeded-solo-realavg-val');
    ConvertRaceTime('#unseeded-solo-forpen-val');
    ConvertRaceTime('#unseeded-solo-fastest-val');
...
function ConvertTimeProfileStampsWithYear(td) {
    ...
    $(td).each(function(){
      ...
      // Write the timestamp back
      $(this).html(d_names[dt.getDay()] + ", " + m_names[dt.getMonth()] + " " + curr_date + "<sup>" + sup + "</sup>" + " " + curr_year + " @ " + curr_time);
    });
}
